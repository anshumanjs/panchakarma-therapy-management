...
// Toggle password visibility (centralized)
function togglePassword(inputId) {
    const input = document.getElementById(inputId);
    if (!input) {
        console.warn(`Input with ID "${inputId}" not found for password toggle.`);
        return;
    }
    const toggleButton = input.parentNode.querySelector('.password-toggle i');
...
window.PanchakarmaPro = {
    ...
    loadDashboardData,
    showNotification, // Export centralized notification function
    closeNotification, // Export centralized notification function
    togglePassword // Export centralized togglePassword function
};
